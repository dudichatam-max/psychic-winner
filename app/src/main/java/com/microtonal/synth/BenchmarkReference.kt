...
data class BenchmarkReferenceSettings(
    ...
    companion object {
        fun defaults(): BenchmarkReferenceSettings = fromJson(JSONObject())
        fun fromJson(o: JSONObject) = BenchmarkReferenceSettings(o.optInt("waveform",3),o.optDouble("volume",.5).toFloat(),o.optDouble("attack",15.0).toFloat(),o.optDouble("decay",50.0).toFloat(),o.optDouble("sustain",.8).toFloat(),o.optDouble("release",200.0).toFloat(),o.optDouble("drive",.35).toFloat(),o.optDouble("reverb",0.0).toFloat(),o.optDouble("cutoff",5000.0).toFloat(),o.optDouble("resonance",.3).toFloat(),o.optDouble("echo",.25).toFloat(),o.optDouble("glide",30.0).toFloat(),o.optInt("octave",0),o.optBoolean("detune"),o.optBoolean("sub"),o.optBoolean("warm"),o.optBoolean("vibe"),o.optBoolean("rip"),o.optBoolean("fuzz"),o.optBoolean("phaz"),o.optBoolean("piano"),o.optBoolean("div2"),o.optBoolean("div3"),o.optBoolean("div4"),o.optBoolean("padTargetKey",true),o.optBoolean("padTargetMic"),o.optBoolean("padTargetLoop"),o.optBoolean("padTargetDrum"),o.optDouble("padWah",0.0).toFloat(),o.optDouble("padOct",0.0).toFloat(),o.optDouble("padCho",0.0).toFloat(),o.optInt("busStutterDiv",0),o.optBoolean("busHoldStop"),o.optInt("drumStutterDiv",0),o.optBoolean("drumHoldStop")) }
}
