...
class DspEngine(private val sampleRate: Int = 44100) {
    ...
    private val revCombFb = floatArrayOf(0.82f, 0.80f, 0.78f, 0.76f)
    ...
    fun processNextSample(
        ...
        val revIn = finalLiveSample + echoSample.toFloat() * 0.35f
        val revOut = if (smoothedReverb > 0.0008) processReverb(revIn) else 0f
        val processedSynth = synthTotal + echoSample + revOut * smoothedReverb * 1.15
